"""
Script to extract chunk annotations from the original_ffd OntoNotes 5.0 data and
...
def convertOntonotesChunks(original_folder, conll_folder):
    ...
    car	I-NP
    accident	I-NP
    :param original_folder: the path to the original_ffd OntoNotes 5.0 data
    ...
    for fold in conll_folders_data + original_folder_data:
        assert os.path.exists(fold), ('Error: %s does not exist. Did you '
                                      'specify the correct original_ffd and CoNLL '
...
if __name__ == '__main__':
    ...
    parser.add_argument('--original_ffd-folder',
                        help='the path to the original_ffd OntoNotes 5.0 folder')
    ...
    convertOntonotesChunks(original_folder='original_ffd-ontonotes-5.0',
